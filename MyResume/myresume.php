...
$pdf->Image("images/$f_name.jpg", 10, 8, 40, '', 'JPG', '', '', true);
// $pdf->WriteHTMLCell(160,50,60,8,$html,0,1);

$pdf->SetFont("Merriweather Sans","I",8.25);
$pdf->Image("ProjectImages/email.png", 10, 40, 6, '', 'PNG', '', '', true);
$pdf->WriteHTMLCell(48,10,9,46,$e_mail,0,1);

$pdf->Image("ProjectImages/mobile.png", 10, 53, 6, '', 'PNG', '', '', true);
$pdf->WriteHTMLCell(48,10,10,60,$phno,0,1);

$pdf->Image("ProjectImages/location.png", 10, 67, 6, '', 'PNG', '', '', true);
$pdf->WriteHTMLCell(48,10,10,77,$address,0,1);

// $pdf->SetFont("Times","I",13);
// $pdf->Cell(180,10,"$f_name details",1,1,'C');

$pdf->SetFont("Merriweather Sans","B",15);
$pdf->SetTextColor(95,158,160);
$pdf->WriteHTMLCell(48,8,10,85,"SKILLS :",'B',1);

$pdf->SetFont("Merriweather Sans","I",10);
$pdf->SetTextColor(0,0,0);
$pdf->WriteHTMLCell(48,'',9,95,$skill,0,1);
$pdf->Ln();

$pdf->SetFont("Merriweather Sans","B",15);
$pdf->SetTextColor(95,158,160);
$pdf->WriteHTMLCell(48,8,10,'',"LANGUAGES :",'B',1);

$pdf->SetFont("Merriweather Sans","I",10);
$pdf->SetTextColor(0,0,0);
$pdf->WriteHTMLCell(48,'',9,122,$languages,0,1);
$pdf->Ln();

$pdf->SetFont("Merriweather Sans","B",15);
$pdf->SetTextColor(95,158,160);
$pdf->WriteHTMLCell(48,8,10,'',"INTRESTS :",'B',1);

$pdf->SetFont("Merriweather Sans","I",10);
$pdf->SetTextColor(0,0,0);
$pdf->WriteHTMLCell(48,'',9,142,$intrests,0,1);
$pdf->Ln();
